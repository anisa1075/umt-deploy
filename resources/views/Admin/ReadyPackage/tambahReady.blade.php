...
@section('title', 'Form Ready Package')

@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Ready Package</h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-12 pb-4">
                <div class="card" style="padding: 1rem; margin-top:1rem;">
                    ...
                    <form action="{{ route('tambah.ready.package') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="desc" name="itinerary" rows="3" placeholder="Masukkan Detail Itinerary ..."></textarea>
                        </div>
