                ...
                <div class="table-responsive">
                    <table class="table table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th>No.</th>
                                <th width="5%">Gambar Destinasii</th>
                                <th width="5%">Foto Deskripsi</th>
                                <th>Negara</th>
                                <th>Slug</th>
                                <th>Deskripsi</th>
                                <th>Link Artikel Lengkap</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success text-center"
                                            href="{{ route('desc.destinasi', $row->id) }}" title="deskripsi"><i
                                                class="fa-solid fa-eye"></i></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-success text-center"
                                            href="{{ $row->link_artikel }}" title="Link Artikel Lengkap" target="_blank">Click Link</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-secondary" href="{{ route('edit.destinasi', $row->id) }}"><i
