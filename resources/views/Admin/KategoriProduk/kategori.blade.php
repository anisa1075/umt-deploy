...
@section('title', 'Tabel Kategori Produk')

@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tabel Kategori Produk</h1>
        <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-4">
            ...
            <a href="#" class="btn btn-primary btn-md" type="button" data-toggle="modal"
                ...
                <i class="fa-solid fa-plus"></i> Kategori Produk
            </a>
                    ...
                    <table class="table table-flush">
                        ...
                        <tbody>
                            @foreach ($kategoriProduk as $row)
                                ...
                                @include('Admin.KategoriProduk.editKategori')
                                @include('Admin.KategoriProduk.deleteKategori')
                            @endforeach
                        </tbody>
                    </table>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambahkan Data Kategori Produk</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('tambah.kategori.produk') }}" method="POST">
                        @csrf
