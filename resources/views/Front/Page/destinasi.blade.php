...
@section('content')
    <div class=" pt-24 lg:flex bg-e9ede7">
        ...
        <div class="">
            <section class=" ">
                <p class="  lg:mr-36 mr-10 lg:pt-12 pl-5 font-Rasa text-2xl" style="font-weight: 600;">Destinasi
                </p>
        ...
        <div class=" bg-white  -mt-4">
            ...
            <div class=" pb-6 pt-2">
                ...
                <div class="">
                    <img class=" w-full px-8 py-6" width="100%" height="100%" src="{{ asset('img1/destifoto.png') }}"
                        alt="Logo UMT">
                ...
                <div class=" p-8 pl-10 pt-10 pb-14">

                    <p class=" font-Rasa font-bold text-black text-3xl text-center">"Explore Berbagai Destinasi"</p>
